...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="status">
		...
		<p class="p1">编辑管理员信息</p>

	    {{Form::model($user,array('url'=>'admin/users/'.$user->id,'method'=>'put','files'=>'true'))}}
	    <ul class="userUl"> 
	    	<li>
			    {{Form::label('name','用户名：')}}
			    {{Form::text('name',$user->name,array('disabled'=>'disabled'))}}
			</li>
			<li>
			...
			<li>
			    {{Form::label('photo','头像：')}}
			    {{Form::file('photo')}}
			    <img src="{{$user->photo}}" alt="" width="60" height="60">
			</li>
			<li>
